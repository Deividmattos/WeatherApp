...
const API_KEY = "9675512563074633ef9bdd41d6ebffcc";
...
const getWeatherDetails = (cityName, lat, lon) => {
    ...
    fetch(WEATHER_API_URL).then(res => res.json()).then(data => {
        ...
        const fiveDaysForecast = data.list.filter(forecast =>{
            ...
            if(!uniqueForescastDays.includes(forecastDate)){
                return uniqueForescastDays.push(forecastDate);
            }
        ...
        alert("An error occurred while fetching the weather forescast");
    });
